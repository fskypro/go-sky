...
type s_CompareHandlers struct {
	sync.RWMutex
	handlers map[string]func(any, string, *s_CmpValue) (bool, error)
}
...
func init() {
	...
	cmpHandlers.handlers["re_match"] = cmpHandlers.reMatch
	...
	cmpHandlers.handlers["in"] = cmpHandlers.in
	cmpHandlers.handlers["arrlen_equal"] = cmpHandlers.arrlenEqual
	cmpHandlers.handlers["arrlen_less_than"] = cmpHandlers.arrlenLessThan
	cmpHandlers.handlers["arrlen_less_equal"] = cmpHandlers.arrlenLessEqual
	cmpHandlers.handlers["arrlen_large_than"] = cmpHandlers.arrlenLargeThan
	cmpHandlers.handlers["arrlen_large_equal"] = cmpHandlers.arrlenLargeEqual
}
